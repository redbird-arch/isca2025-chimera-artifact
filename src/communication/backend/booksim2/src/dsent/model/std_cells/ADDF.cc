...
namespace DSENT
{
    ...
    void ADDF::propagateTransitionInfo()
    {
        ...
        ASSERT(LibUtil::DsentMath::isEqual((S_prob_00 + S_prob_01 + S_prob_01 + S_prob_11), 1.0), 
        ...
        // Check that probabilities add up to 1.0 with some finite tolerance
        ASSERT(LibUtil::DsentMath::isEqual((CO_prob_00 + CO_prob_01 + CO_prob_01 + CO_prob_11), 1.0), 
            "[Error] " + getInstanceName() +  "Output S transition probabilities must add up to 1 (" +
