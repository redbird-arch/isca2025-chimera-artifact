...
namespace DSENT
{
    ...
    void DFFQ::propagateTransitionInfo()
    {
        ...
        if(LibUtil::DsentMath::isEqual(CK_num_trans_10 + CK_num_trans_00, 0.0) || LibUtil::DsentMath::isEqual(D_freq_mult, 0.0))
        {
        ...
        if(LibUtil::DsentMath::isEqual(CK_num_trans_01, 0.0) || LibUtil::DsentMath::isEqual(D_freq_mult, 0.0))
        {
