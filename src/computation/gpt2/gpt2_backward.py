...
class attention():
    ...
    def cal(self, batch_size, sequence_length, scalesim=True):
        if scalesim:
            self.cal_tensor = sum_total_cycles(os.path.join(file_path, f'../backend/runfile/medium_gpt_attention_normal/GoogleTPU_v1_ws/COMPUTE_REPORT.csv'))
        else:
            self.cal_tensor = 0
            self.cal_vector = 0
            self.cal_reorder = 0
...
class attention_input_backward():
    ...
    def cal(self, batch_size, sequence_length, scalesim=True):
        if scalesim:
            self.cal_tensor = sum_total_cycles(os.path.join(file_path, f'../backend/runfile/medium_gpt_attention_input_backward/GoogleTPU_v1_ws/COMPUTE_REPORT.csv'))
        else:
            self.cal_tensor = 0
            self.cal_vector = 0
            self.cal_reorder = 0
...
class attention_weight_backward():
    ...
    def cal(self, batch_size, sequence_length, scalesim=True):
        if scalesim:
            self.cal_tensor = sum_total_cycles(os.path.join(file_path, f'../backend/runfile/medium_gpt_attention_weight_backward/GoogleTPU_v1_ws/COMPUTE_REPORT.csv'))
        else:
            self.cal_tensor = 0
            self.cal_vector = 0
            self.cal_reorder = 0
...
class mlp():
    ...
    def cal(self, batch_size, sequence_length, scalesim=True):
        if scalesim:
            self.cal_tensor = sum_total_cycles(os.path.join(file_path, f'../backend/runfile/medium_gpt_mlp_normal/GoogleTPU_v1_ws/COMPUTE_REPORT.csv'))
        else:
            self.cal_tensor = 0
            self.cal_vector = 0
            self.cal_reorder = 0
...
class mlp_input_backward():
    ...
    def cal(self, batch_size, sequence_length, scalesim=True):
        if scalesim:
            self.cal_tensor = sum_total_cycles(os.path.join(file_path, f'../backend/runfile/medium_gpt_mlp_input_backward/GoogleTPU_v1_ws/COMPUTE_REPORT.csv'))
        else:
            self.cal_tensor = 0
            self.cal_vector = 0
            self.cal_reorder = 0
...
class mlp_weight_backward():
    ...
    def cal(self, batch_size, sequence_length, scalesim=True):
        if scalesim:
            self.cal_tensor = sum_total_cycles(os.path.join(file_path, f'../backend/runfile/medium_gpt_mlp_weight_backward/GoogleTPU_v1_ws/COMPUTE_REPORT.csv'))
        else:
            self.cal_tensor = 0
            self.cal_vector = 0
            self.cal_reorder = 0
