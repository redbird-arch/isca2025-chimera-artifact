...
config_path = os.path.join(file_path, '../gpt2/input/gpt2-medium-config.json')                           
...
with open(os.path.join(file_path, 'medium_gpt_attention.csv'), 'w', newline='') as file:
...
with open(os.path.join(file_path, 'medium_gpt_mlp.csv'), 'w', newline='') as file:
