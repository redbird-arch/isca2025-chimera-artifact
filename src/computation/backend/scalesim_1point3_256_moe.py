...
with open(os.path.join(file_path, 'moe_1point3_256_attention.csv'), 'w', newline='') as file:
...
with open(os.path.join(file_path, 'moe_1point3_256_mlp.csv'), 'w', newline='') as file:
...
with open(os.path.join(file_path, 'moe_1point3_256_moe.csv'), 'w', newline='') as file:
    for item in gpt_mlp_tasks:
            line = ','.join(map(str, item)) + ','
            file.write(line + '\n')
