...
model_name = 'gpt2-xl'
config_path = os.path.join(file_path, '../gpt2/input/gpt2-xl-config.json')                           
...
with open(os.path.join(file_path, 'gpt_attention.csv'), 'w', newline='') as file:
...
with open(os.path.join(file_path, 'gpt_mlp.csv'), 'w', newline='') as file:
