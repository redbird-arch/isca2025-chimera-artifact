...
class sequence_expert(object):
    ...
    def base(
        ...
        allgather_dependency_list = [[[] for _ in range(source_x_number)] for _ in range(source_y_number)]
            ...
            for group_x_idx in range(data_parallelism_degree[0]):
                ...
                for y_idx in range(group_y_number):
                    for x_idx in range(group_x_number):
                        ...
                        group_node_x = x_idx + group_x_idx * group_x_number
                        group_node_idx = group_node_y * source_x_number + group_node_x
                        allgather_dependency_list[group_node_y][group_node_x] = group_allgather_dependency_list[y_idx][x_idx]
            ...
            for group_x_idx in range(data_parallelism_degree[0]):
                ...
                for y_idx in range(group_y_number):
                    ...
                    for x_idx in range(group_x_number):
                        ...
                        group_node_x = x_idx + group_x_idx * group_x_number
                        group_node_idx = group_node_y * source_x_number + group_node_x
                        group_row_list.append(alltoall_dependency_list[group_node_y][group_node_x])
                    group.append(group_row_list)
                groups_current_dependency_list.append(group)

        group_alltoall_event_tag = alltoall_event_tag
        after_alltoall_dependency_list = [[[] for _ in range(source_x_number)] for _ in range(source_y_number)]
            ...
            for group_x_idx in range(data_parallelism_degree[0]):
                ...
                for y_idx in range(group_y_number):
                    for x_idx in range(group_x_number):
                        ...
                        group_node_x = x_idx + group_x_idx * group_x_number
                        group_node_idx = group_node_y * source_x_number + group_node_x
                        after_alltoall_dependency_list[group_node_y][group_node_x] = group_alltoall_dependency_list[y_idx][x_idx]
...
class sequence_expert_moe(object):
    ...
    def base(
        ...
        next_alltoall_dependency_list = [[[] for _ in range(source_x_number)] for _ in range(source_y_number)]
            ...
            for group_x_idx in range(data_parallelism_degree[0]):
                ...
                for y_idx in range(group_y_number):
                    ...
                    for x_idx in range(group_x_number):
                        ...
                        group_node_x = x_idx + group_x_idx * group_x_number
                        group_node_idx = group_node_y * source_x_number + group_node_x
                        group_row_list.append(reducelocal_dependency_list[group_node_y][group_node_x])
                    group.append(group_row_list)
                groups_current_dependency_list.append(group)
            ...
            for group_x_idx in range(data_parallelism_degree[0]):
                ...
                for y_idx in range(group_y_number):
                    for x_idx in range(group_x_number):
                        ...
                        group_node_x = x_idx + group_x_idx * group_x_number
                        group_node_idx = group_node_y * source_x_number + group_node_x
                        next_alltoall_dependency_list[group_node_y][group_node_x] = group_alltoall_dependency_list[y_idx][x_idx]
...
if __name__ == "__main__":
    ...
    build
    '''
    se_base_node_network, se_base_noc_network = build(
    ...
    initial_se_base_dependency_list = [[[] for _ in range(source_shape[1])] for _ in range(source_shape[0])]

    se_base_event_tag, se_base_dependency_list = te.fusion(
