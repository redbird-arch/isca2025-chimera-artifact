...
if __name__ == "__main__":
    ...
    build
    '''
    ps_base_node_network, ps_base_noc_network = build_3D(
    ...
    initial_ps_base_dependency_list = [[[[] for _ in range(source_shape[2])] for _ in range(source_shape[1])] for _ in range(source_shape[0])]
