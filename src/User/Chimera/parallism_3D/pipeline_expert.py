...
class pipeline_expert(object):
    ...
    def base(
        ...
        medium_x_number: int, medium_y_number: int, medium_z_number: int,
        ...
        pointtopoint_event_tag, pointtopoint_dependency_list = self.pointtopoint.cal_time(
            ...
            target_x_number=medium_x_number, target_y_number=medium_y_number, target_z_number=medium_z_number,
        ...
        alltoall_event_tag, alltoall_dependency_list = self.alltoall.cal_time(
            ...
            source_x_number=medium_x_number, source_y_number=medium_y_number, source_z_number=medium_z_number, 
            topology_x_limitation=topology_x_limitation, topology_y_limitation=topology_y_limitation, topology_z_limitation=topology_z_limitation,
...
if __name__ == "__main__":
    ...
    top_k = 2
    medium_nodes = [(0, 1, 0), (0, 1, 1)]
    medium_shape = [1, 1, 2]
    target_nodes = [(1, 0, 0), (1, 0, 1)]
    target_shape = [1, 1, 2]
    whole_flits = 294912 
    ...
    build
    '''
    pe_base_node_network, pe_base_noc_network = build_3D(
    ...
    initial_pe_base_dependency_list = [[[[] for _ in range(source_shape[2])] for _ in range(source_shape[1])] for _ in range(source_shape[0])]
