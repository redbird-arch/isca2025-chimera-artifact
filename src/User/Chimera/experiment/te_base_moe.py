...
'''
    ...
    code += '''
        ...
        for dependency_y in cluster_ordertoorder_dependency_list:
            for dependency_x in dependency_y:
                for dependency_event in dependency_x:
                    if dependency_event not in cluster_sub0_ordertoorder_events:
                        cluster_sub0_ordertoorder_events.append(dependency_event)
        cluster_sub0_ordertoorder_dependency_list = [[cluster_sub0_ordertoorder_events for _ in range(cluster_sub0_shapes[cluster_step][1])] for _ in range(cluster_sub0_shapes[cluster_step][0])]
        ...
        cluster_sub1_ordertoorder_dependency_list = [[cluster_sub1_ordertoorder_events for _ in range(cluster_sub1_shapes[cluster_step][1])] for _ in range(cluster_sub1_shapes[cluster_step][0])]
