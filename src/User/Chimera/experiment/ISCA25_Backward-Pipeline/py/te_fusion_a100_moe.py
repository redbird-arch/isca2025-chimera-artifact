...
for cluster_idx, cluster_step in enumerate([0, 1, 2]):
    for layer_step in range(2):
        if cluster_idx == 0:
            ...
            if layer_step == 0:
                cluster_sub0_allgather_event_tag, cluster_sub0_allgather_dependency_list = allgather_api.cal_time(
                    whole_nodes=node_network, current_event_tag=stage_manytomany_event_tag, current_dependency_list=cluster_stage_pointtopoint_dependency_list,
                    source_nodes_coordinates_list=cluster_sub0_nodes_lists[cluster_step],
                    source_x_number=cluster_sub0_shapes[cluster_step][1], source_y_number=cluster_sub0_shapes[cluster_step][0],
                    topology_x_limitation=node_k, topology_y_limitation=node_k,
                    message_flits=pass_bytes,
                ...
                cluster_sub1_allgather_event_tag, cluster_sub1_allgather_dependency_list = allgather_api.cal_time(
                    whole_nodes=node_network, current_event_tag=cluster_sub0_allgather_event_tag, current_dependency_list=cluster_stage_pointtopoint_dependency_list,
                    source_nodes_coordinates_list=cluster_sub1_nodes_lists[cluster_step],
                    source_x_number=cluster_sub1_shapes[cluster_step][1], source_y_number=cluster_sub1_shapes[cluster_step][0],
                    topology_x_limitation=node_k, topology_y_limitation=node_k,
                    message_flits=pass_bytes,
        ...
        if cluster_idx == 0:
            if layer_step == 0:
                ...
                stage_sub1_allgather_event_tag, stage_sub1_allgather_dependency_list = allgather_api.cal_time(
                    whole_nodes=node_network, current_event_tag=stage_sub0_allgather_event_tag, current_dependency_list=initial_cluster_sub1_dependency_lists[cluster_step],
                    source_nodes_coordinates_list=cluster_sub1_nodes_lists[cluster_step],
                    source_x_number=cluster_sub1_shapes[cluster_step][1], source_y_number=cluster_sub1_shapes[cluster_step][0],
                    topology_x_limitation=node_k, topology_y_limitation=node_k,
                    message_flits=pass_bytes,
                ...
                stage_alltoall_event_tag, stage_alltoall_dependency_list = alltoall_api.cal_time(
                    whole_nodes=node_network, current_event_tag=stage_sub0_attention_input_event_tag, current_dependency_list=cluster_stage_attention_dependency_list,
                    source_nodes_coordinates_list=cluster_nodes_lists[cluster_step],
                    source_x_number=cluster_shapes[cluster_step][1], source_y_number=cluster_shapes[cluster_step][0],
                    topology_x_limitation=node_k, topology_y_limitation=node_k,
                    message_flits=pass_bytes*model_config['top_k']*cluster_dataparallels[cluster_step][0]*cluster_dataparallels[cluster_step][1],
                ...
                stage_sub0_allgather_event_tag, stage_sub0_allgather_dependency_list = allgather_api.cal_time(
                    whole_nodes=node_network, current_event_tag=stage_alltoall_event_tag, current_dependency_list=stage_alltoall_dependency_list,
                    source_nodes_coordinates_list=cluster_sub0_nodes_lists[cluster_step],
                    source_x_number=cluster_sub0_shapes[cluster_step][1], source_y_number=cluster_sub0_shapes[cluster_step][0],
                    topology_x_limitation=node_k, topology_y_limitation=node_k,
                    message_flits=pass_bytes,
                ...
                stage_sub1_allgather_event_tag, stage_sub1_allgather_dependency_list = allgather_api.cal_time(
                    whole_nodes=node_network, current_event_tag=stage_sub0_allgather_event_tag, current_dependency_list=stage_alltoall_dependency_list,
                    source_nodes_coordinates_list=cluster_sub1_nodes_lists[cluster_step],
                    source_x_number=cluster_sub1_shapes[cluster_step][1], source_y_number=cluster_sub1_shapes[cluster_step][0],
                    topology_x_limitation=node_k, topology_y_limitation=node_k,
                    message_flits=pass_bytes,
            ...
            if layer_step == 0:
                ...
                stage_sub1_allgather_event_tag, stage_sub1_allgather_dependency_list = allgather_api.cal_time(
                    whole_nodes=node_network, current_event_tag=stage_sub0_allgather_event_tag, current_dependency_list=cluster_stage_pointtopoint_dependency_list,
                    source_nodes_coordinates_list=cluster_sub1_nodes_lists[cluster_step],
                    source_x_number=cluster_sub1_shapes[cluster_step][1], source_y_number=cluster_sub1_shapes[cluster_step][0],
                    topology_x_limitation=node_k, topology_y_limitation=node_k,
                    message_flits=pass_bytes,
        ...
        if layer_step == 0:
            stage_moe_input_event_tag, stage_moe_input_dependency_list = compute_2d_base(
                whole_nodes=node_network, current_event_tag=stage_sub1_allgather_event_tag, current_dependency_list=stage_allgather_dependency_list,
                source_nodes_coordinates_list=cluster_nodes_lists[cluster_step],
                source_x_number=cluster_shapes[cluster_step][1], source_y_number=cluster_shapes[cluster_step][0],
                topology_x_limitation=node_k, topology_y_limitation=node_k,
                message_flits=moe_input_backward_bytes/cluster_shapes[cluster_step][0]/cluster_shapes[cluster_step][1],
            ...
            for sublist1, sublist2 in zip(stage_attention_weight_dependency_list, stage_allgather_dependency_list):
                merged_sublist = []
                for pair1, pair2 in zip(sublist1, sublist2):
                    merged_sublist.append(pair1 + pair2)
            ...
            stage_moe_input_event_tag, stage_moe_input_dependency_list = compute_2d_base(
                whole_nodes=node_network, current_event_tag=stage_sub1_allgather_event_tag, current_dependency_list=stage_weight_allgather_dependency_list,
                source_nodes_coordinates_list=cluster_nodes_lists[cluster_step],
                source_x_number=cluster_shapes[cluster_step][1], source_y_number=cluster_shapes[cluster_step][0],
                topology_x_limitation=node_k, topology_y_limitation=node_k,
                message_flits=moe_input_backward_bytes/cluster_shapes[cluster_step][0]/cluster_shapes[cluster_step][1],
        ...
        stage_sub0_reducescatter_event_tag, stage_sub0_reducescatter_dependency_list = reducescatter_api.cal_time(
            whole_nodes=node_network, current_event_tag=stage_sub1_reducescatter_event_tag, current_dependency_list=stage_moe_input_dependency_list,
            source_nodes_coordinates_list=cluster_sub0_nodes_lists[cluster_step],
            source_x_number=cluster_sub0_shapes[cluster_step][1], source_y_number=cluster_sub0_shapes[cluster_step][0],
            topology_x_limitation=node_k, topology_y_limitation=node_k,
            message_flits=pass_bytes,
        ...
        stage_alltoall_event_tag, stage_alltoall_dependency_list = alltoall_api.cal_time(
            whole_nodes=node_network, current_event_tag=stage_sub0_reducescatter_event_tag, current_dependency_list=stage_reducescatter_dependency_list,
            source_nodes_coordinates_list=cluster_nodes_lists[cluster_step],
            source_x_number=cluster_shapes[cluster_step][1], source_y_number=cluster_shapes[cluster_step][0],
            topology_x_limitation=node_k, topology_y_limitation=node_k,
            message_flits=pass_bytes*model_config['top_k']*cluster_dataparallels[cluster_step][0]*cluster_dataparallels[cluster_step][1],
        ...
        stage_sub0_allgather_event_tag, stage_sub0_allgather_dependency_list = allgather_api.cal_time(
            whole_nodes=node_network, current_event_tag=stage_sub1_allgather_event_tag, current_dependency_list=stage_alltoall_dependency_list,
            source_nodes_coordinates_list=cluster_sub0_nodes_lists[cluster_step],
            source_x_number=cluster_sub0_shapes[cluster_step][1], source_y_number=cluster_sub0_shapes[cluster_step][0],
            topology_x_limitation=node_k, topology_y_limitation=node_k,
            message_flits=pass_bytes,
    ...
    if cluster_step < clusters_number - 1:
        ...
        stage_manytomany_event_tag, stage_manytomany_dependency_list = manytomany_api.cal_time(
            whole_nodes=node_network, current_event_tag=cluster_manytomany_event_tag, current_dependency_list=cluster_stage_attention_dependency_list,
            source_nodes_coordinates_list=cluster_nodes_lists[cluster_step],
            target_nodes_coordinates_list=cluster_nodes_lists[cluster_step+1],
            source_x_number=cluster_shapes[cluster_step][1], source_y_number=cluster_shapes[cluster_step][0],
            target_x_number=cluster_shapes[cluster_step+1][1], target_y_number=cluster_shapes[cluster_step+1][0],
        ...
        cluster_manytomany_events = []
        for dependency_y in stage_manytomany_dependency_list:
            for dependency_x in dependency_y:
                for dependency_event in dependency_x:
                    if dependency_event not in cluster_manytomany_events:
                        cluster_manytomany_events.append(dependency_event)

        stage_sub0_manytomany_dependency_list = [[cluster_manytomany_events for _ in range(cluster_sub0_shapes[cluster_step+1][1])] for _ in range(cluster_sub0_shapes[cluster_step+1][0])]
        stage_sub1_manytomany_dependency_list = [[cluster_manytomany_events for _ in range(cluster_sub1_shapes[cluster_step+1][1])] for _ in range(cluster_sub1_shapes[cluster_step+1][0])]

        cluster_stage_pointtopoint_dependency_list = []
        for sublist1, sublist2 in zip(cluster_manytomany_dependency_list, stage_manytomany_dependency_list):
            merged_sublist = []
            for pair1, pair2 in zip(sublist1, sublist2):
                merged_sublist.append(pair1 + pair2)
