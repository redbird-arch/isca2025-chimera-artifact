...
gpt_sp_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/ts_base_dojo_scaling_gpt.txt"))
gpt_sp_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/ts_fusion_dojo_scaling_gpt.txt"))
data[0][0][0] = safe_divide(gpt_sp_base, gpt_sp_fuse)
print("Inference Speedup of gpt sp", "dojo", ":", data[0][0][0])

gpt_sp_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/ts_base_tpuv3_scaling_gpt.txt"))
gpt_sp_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/ts_fusion_tpuv3_scaling_gpt.txt"))
data[0][0][1] = safe_divide(gpt_sp_base, gpt_sp_fuse)
print("Inference Speedup of gpt sp", "tpuv3", ":", data[0][0][1])

gpt_sp_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/ts_base_tpuv4_scaling_gpt.txt"))
gpt_sp_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/ts_fusion_tpuv4_scaling_gpt.txt"))
data[0][0][2] = safe_divide(gpt_sp_base, gpt_sp_fuse)
print("Inference Speedup of gpt sp", "tpuv4", ":", data[0][0][2])

gpt_sp_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/ts_base_a100_scaling_gpt.txt"))
gpt_sp_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/ts_fusion_a100_scaling_gpt.txt"))
data[0][0][3] = safe_divide(gpt_sp_base, gpt_sp_fuse)
print("Inference Speedup of gpt sp", "a100", ":", data[0][0][3])


gpt_tp_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/tp_alpa_dojo_scaling_gpt.txt"))
gpt_tp_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/tp_fusion_dojo_scaling_gpt.txt"))
data[0][1][0] = safe_divide(gpt_tp_base, gpt_tp_fuse)
print("Inference Speedup of gpt tp", "dojo", ":", data[0][1][0])

gpt_tp_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/tp_alpa_tpuv3_scaling_gpt.txt"))
gpt_tp_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/tp_fusion_tpuv3_scaling_gpt.txt"))
data[0][1][1] = safe_divide(gpt_tp_base, gpt_tp_fuse)
print("Inference Speedup of gpt tp", "tpuv3", ":", data[0][1][1])

gpt_tp_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/tp_alpa_tpuv4_scaling_gpt.txt"))
gpt_tp_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/tp_fusion_tpuv4_scaling_gpt.txt"))
data[0][1][2] = safe_divide(gpt_tp_base, gpt_tp_fuse)
print("Inference Speedup of gpt tp", "tpuv4", ":", data[0][1][2])

gpt_tp_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/tp_alpa_a100_scaling_gpt.txt"))
gpt_tp_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/tp_fusion_a100_scaling_gpt.txt"))
data[0][1][3] = safe_divide(gpt_tp_base, gpt_tp_fuse)
print("Inference Speedup of gpt tp", "a100", ":", data[0][1][3])


moe_se_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/se_base_dojo_expand_moe.txt"))
moe_se_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/se_fusion_dojo_expand_moe.txt"))
data[1][0][0] = safe_divide(moe_se_base, moe_se_fuse)
print("Inference Speedup of moe se", "dojo", ":", data[1][0][0])

moe_se_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/se_base_tpuv3_expand_moe.txt"))
moe_se_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/se_fusion_tpuv3_expand_moe.txt"))
data[1][0][1] = safe_divide(moe_se_base, moe_se_fuse)
print("Inference Speedup of moe se", "tpuv3", ":", data[1][0][1])

moe_se_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/se_base_tpuv4_scaling_moe.txt"))
moe_se_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/se_fusion_tpuv4_scaling_moe.txt"))
data[1][0][2] = safe_divide(moe_se_base, moe_se_fuse)
print("Inference Speedup of moe se", "tpuv4", ":", data[1][0][2])

moe_se_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/se_base_a100_expand_moe.txt"))
moe_se_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/se_fusion_a100_expand_moe.txt"))
data[1][0][3] = safe_divide(moe_se_base, moe_se_fuse)
print("Inference Speedup of moe se", "a100", ":", data[1][0][3])


moe_te_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/te_base_dojo_expand_moe.txt"))
moe_te_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/te_fusion_dojo_expand_moe.txt"))
data[1][1][0] = safe_divide(moe_te_base, moe_te_fuse)
print("Inference Speedup of moe te", "dojo", ":", data[1][1][0])

moe_te_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/te_base_tpuv3_expand_moe.txt"))
moe_te_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/te_fusion_tpuv3_expand_moe.txt"))
data[1][1][1] = safe_divide(moe_te_base, moe_te_fuse)
print("Inference Speedup of moe te", "tpuv3", ":", data[1][1][1])

moe_te_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/te_base_tpuv4_scaling_moe.txt"))
moe_te_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/te_fusion_tpuv4_scaling_moe.txt"))
data[1][1][2] = safe_divide(moe_te_base, moe_te_fuse)
print("Inference Speedup of moe te", "tpuv4", ":", data[1][1][2])

moe_te_base = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/te_base_a100_expand_moe.txt"))
moe_te_fuse = safe_read(os.path.join(file_path, "../ISCA25_Forward/txt/te_fusion_a100_expand_moe.txt"))
...
# plt.savefig(os.path.join(file_path, '../Pictures/Chimera_EndtoEnd_forward_scaling' + '.png'), format='png', dpi=300)
# plt.savefig(os.path.join(file_path, '../Pictures/Chimera_EndtoEnd_forward_scaling' + '.svg'), format='svg', dpi=800)
plt.savefig(os.path.join(file_path, '../Pictures/Chimera_EndtoEnd_forward_scaling' + '.pdf'), format='pdf', dpi=800)
