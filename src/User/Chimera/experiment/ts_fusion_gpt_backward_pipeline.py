...
'''
    ...
    if cluster_step < clusters_number - 1:
        cluster_pointtopoint_event_tag, cluster_pointtopoint_dependency_list = manytomany_api.cal_time(
            whole_nodes=node_network, current_event_tag=stage_attention_weight_event_tag, current_dependency_list=cluster_stage_attention_dependency_list,
            source_nodes_coordinates_list=cluster_nodes_lists[cluster_step],
        ...
        stage_pointtopoint_event_tag, stage_pointtopoint_dependency_list = manytomany_api.cal_time(
...
'''
    ...
    file_path = os.path.join(target_folder_py, 'ts_fusion_' + hardware_config + '_gpt.py')
