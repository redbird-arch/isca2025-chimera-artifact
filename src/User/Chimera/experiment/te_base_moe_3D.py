...
'''
    ...
    code += '''
        if cluster_idx == 0:
            ...
            if layer_step == 0:
                ...
                cluster_sub1_allgather_event_tag, cluster_sub1_allgather_dependency_list = allgather_api.cal_time(
                    whole_nodes=node_network, current_event_tag=cluster_sub0_allgather_event_tag, current_dependency_list=initial_cluster_sub0_dependency_lists[cluster_step],
                    source_nodes_coordinates_list=cluster_sub0_nodes_lists[cluster_step],
                ...
                cluster_sub0_allgather_event_tag, cluster_sub0_allgather_dependency_list = allgather_api.cal_time(
                    whole_nodes=node_network, current_event_tag=cluster_ordertoorder_event_tag, current_dependency_list=cluster_sub0_ordertoorder_dependency_list,
                    source_nodes_coordinates_list=cluster_sub0_nodes_lists[cluster_step],
                    source_x_number=cluster_sub0_shapes[cluster_step][2], source_y_number=cluster_sub0_shapes[cluster_step][1], source_z_number=cluster_sub0_shapes[cluster_step][0],
                    topology_x_limitation=node_k, topology_y_limitation=node_k, topology_z_limitation=node_k,
                    message_flits=pass_bytes,
                ...
                cluster_sub1_allgather_event_tag, cluster_sub1_allgather_dependency_list = allgather_api.cal_time(
                    whole_nodes=node_network, current_event_tag=cluster_sub0_allgather_event_tag, current_dependency_list=cluster_sub1_ordertoorder_dependency_list,
            ...
            if layer_step == 0:
                cluster_sub0_allgather_event_tag, cluster_sub0_allgather_dependency_list = allgather_api.cal_time(
                    whole_nodes=node_network, current_event_tag=cluster_sub1_pointtopoint_event_tag, current_dependency_list=cluster_sub0_pointtopoint_dependency_list,
                    source_nodes_coordinates_list=cluster_sub0_nodes_lists[cluster_step],
                    source_x_number=cluster_sub0_shapes[cluster_step][2], source_y_number=cluster_sub0_shapes[cluster_step][1], source_z_number=cluster_sub0_shapes[cluster_step][0],
                    topology_x_limitation=node_k, topology_y_limitation=node_k, topology_z_limitation=node_k,
                    message_flits=pass_bytes,
                ...
                cluster_sub1_allgather_event_tag, cluster_sub1_allgather_dependency_list = allgather_api.cal_time(
                    whole_nodes=node_network, current_event_tag=cluster_sub0_allgather_event_tag, current_dependency_list=cluster_sub1_pointtopoint_dependency_list,
                    source_nodes_coordinates_list=cluster_sub0_nodes_lists[cluster_step],
                    source_x_number=cluster_sub1_shapes[cluster_step][2], source_y_number=cluster_sub1_shapes[cluster_step][1], source_z_number=cluster_sub1_shapes[cluster_step][0],
                    topology_x_limitation=node_k, topology_y_limitation=node_k, topology_z_limitation=node_k,
                    message_flits=pass_bytes,
        ...
        cluster_sub1_allreduce_event_tag, cluster_sub1_allreduce_dependency_list = allreduce_api.cal_time(
            whole_nodes=node_network, current_event_tag=cluster_sub0_allreduce_event_tag, current_dependency_list=cluster_sub1_attention_dependency_list,
            source_nodes_coordinates_list=cluster_sub1_nodes_lists[cluster_step],
            source_x_number=cluster_sub1_shapes[cluster_step][2], source_y_number=cluster_sub1_shapes[cluster_step][1], source_z_number=cluster_sub1_shapes[cluster_step][0],
            topology_x_limitation=node_k, topology_y_limitation=node_k, topology_z_limitation=node_k,
            message_flits=pass_bytes,
        ...
        cluster_sub0_allgather_event_tag, cluster_sub0_allgather_dependency_list = allgather_api.cal_time(
            whole_nodes=node_network, current_event_tag=cluster_sub1_allreduce_event_tag, current_dependency_list=cluster_sub0_allreduce_dependency_list,
            source_nodes_coordinates_list=cluster_sub0_nodes_lists[cluster_step],
            source_x_number=cluster_sub0_shapes[cluster_step][2], source_y_number=cluster_sub0_shapes[cluster_step][1], source_z_number=cluster_sub0_shapes[cluster_step][0],
            topology_x_limitation=node_k, topology_y_limitation=node_k, topology_z_limitation=node_k,
            message_flits=pass_bytes,
        ...
        cluster_sub1_allgather_event_tag, cluster_sub1_allgather_dependency_list = allgather_api.cal_time(
            whole_nodes=node_network, current_event_tag=cluster_sub0_allgather_event_tag, current_dependency_list=cluster_sub1_allreduce_dependency_list,
            source_nodes_coordinates_list=cluster_sub1_nodes_lists[cluster_step],
            source_x_number=cluster_sub1_shapes[cluster_step][2], source_y_number=cluster_sub1_shapes[cluster_step][1], source_z_number=cluster_sub1_shapes[cluster_step][0],
            topology_x_limitation=node_k, topology_y_limitation=node_k, topology_z_limitation=node_k,
            message_flits=pass_bytes,
        ...
        cluster_sub1_allreduce_event_tag, cluster_sub1_allreduce_dependency_list = allreduce_api.cal_time(
            whole_nodes=node_network, current_event_tag=cluster_sub0_allreduce_event_tag, current_dependency_list=cluster_sub1_mlp_dependency_list,
            source_nodes_coordinates_list=cluster_sub1_nodes_lists[cluster_step],
            source_x_number=cluster_sub1_shapes[cluster_step][2], source_y_number=cluster_sub1_shapes[cluster_step][1], source_z_number=cluster_sub1_shapes[cluster_step][0],
            topology_x_limitation=node_k, topology_y_limitation=node_k, topology_z_limitation=node_k,
            message_flits=pass_bytes,
        ...
        cluster_ordertoorder_event_tag, cluster_ordertoorder_dependency_list = ordertoorder_api.cal_time(
            whole_nodes=node_network, current_event_tag=cluster_sub1_allreduce_event_tag, current_dependency_list=cluster_allreduce_dependency_list,
        ...
        cluster_sub1_allreduce_event_tag, cluster_sub1_allreduce_dependency_list = allreduce_api.cal_time(
            whole_nodes=node_network, current_event_tag=cluster_sub0_allreduce_event_tag, current_dependency_list=cluster_sub1_moe_dependency_list,
            source_nodes_coordinates_list=cluster_sub1_nodes_lists[cluster_step],
            source_x_number=cluster_sub1_shapes[cluster_step][2], source_y_number=cluster_sub1_shapes[cluster_step][1], source_z_number=cluster_sub1_shapes[cluster_step][0],
            topology_x_limitation=node_k, topology_y_limitation=node_k, topology_z_limitation=node_k,
            message_flits=pass_bytes,
        ...
        record_event_tags.append(cluster_ordertoorder_dependency_list)

        cluster_sub0_ordertoorder_events = []
        for dependency_z in cluster_ordertoorder_dependency_list:
            for dependency_y in dependency_z:
                for dependency_x in dependency_y:
                    for dependency_event in dependency_x:
                        if dependency_event not in cluster_sub0_ordertoorder_events:
                            cluster_sub0_ordertoorder_events.append(dependency_event)
        cluster_sub0_ordertoorder_dependency_list = [[[cluster_sub0_ordertoorder_events for _ in range(cluster_sub0_shapes[cluster_step][2])] for _ in range(cluster_sub0_shapes[cluster_step][1])] for _ in range(cluster_sub0_shapes[cluster_step][0])]

        cluster_sub1_ordertoorder_events = []
        for dependency_z in cluster_ordertoorder_dependency_list:
            for dependency_y in dependency_z:
                for dependency_x in dependency_y:
                    for dependency_event in dependency_x:
                        if dependency_event not in cluster_sub1_ordertoorder_events:
                            cluster_sub1_ordertoorder_events.append(dependency_event)
        cluster_sub1_ordertoorder_dependency_list = [[[cluster_sub1_ordertoorder_events for _ in range(cluster_sub1_shapes[cluster_step][2])] for _ in range(cluster_sub1_shapes[cluster_step][1])] for _ in range(cluster_sub1_shapes[cluster_step][0])]
    ...
    if cluster_step < clusters_number - 1:
        ...
        cluster_sub1_pointtopoint_event_tag, cluster_sub1_pointtopoint_dependency_list = pointtopoint_api.cal_time(
            whole_nodes=node_network, current_event_tag=cluster_sub0_pointtopoint_event_tag, current_dependency_list=cluster_sub1_ordertoorder_dependency_list,
            source_nodes_coordinates_list=cluster_sub1_nodes_lists[cluster_step],
